...
def first_three(input_list):
    ...
    """
    list_first_three = input_list[0:3]

    return list_first_three
...
def last_five(input_list):
    ...
    list_last_five = input_list[-5:]
    
    return list_last_five
